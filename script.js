const words = [
      ...
      'Clock  : "A machine of great moral value to man, allaying his concern for the future by reminding him what a lot of time remains to him."',
      ...
      'Yankee  : "In Europe, an American. In the Northern States of our Union, a New Englander. In the Southern States the word is unknown."',

];

const randomWord = () => {
    let newWord = Math.floor(Math.random() * (words.length));
    document.getElementById("displayWord").innerHTML = words[newWord];
}
